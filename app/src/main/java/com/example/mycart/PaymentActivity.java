...
public class PaymentActivity extends AppCompatActivity implements PaymentResultListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        itemsList= (ArrayList<Items>) getIntent().getSerializableExtra("itemList");
        ...
        if (itemsList!=null && itemsList.size()>0)
        {
            ...
            mTotal.setText("Rs "+amount+"");
        }
         else {
             mTotal.setText("Rs "+amount+"");
             mSubTotalAmount.setText("Rs "+amount+"");
    ...
    public  void startPayment()
    {
           ...
           try
           {
               ...
               //Set Company Name
               options.put("name", "Digital Websynation");
               //Ref no
               ...
               //email
               preFill.put("email", "mustaque@digitalwebsynation.com");
               //contact
               preFill.put("contact", "9162022627");
