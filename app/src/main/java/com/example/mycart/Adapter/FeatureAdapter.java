...
public class FeatureAdapter extends RecyclerView.Adapter<FeatureAdapter.ViewHolder>
{
    ...
    @Override
    public void onBindViewHolder(@NonNull FeatureAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position)
    {
        holder.mFetCost.setText(mFeatureList.get(position).getPrice()+" Price");
